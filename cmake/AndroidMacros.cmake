macro(add_Android_Project target_name activity_name package_name project_directory target_source_files target_include_dirs target_link_libs)
    ...
    add_custom_target(${target_name}_copy-AndroidManifest
        DEPENDS ${target_name}
        COMMAND ${CMAKE_COMMAND} -E copy_if_different ${CMAKE_SOURCE_DIR}/examples/AndroidManifest.xml ${project_directory}/AndroidManifest.xml
    )

    if(EXISTS ${CMAKE_SOURCE_DIR}/examples/${target_name}/resources)
        add_custom_target(${target_name}_copy-resources
            DEPENDS ${target_name}_copy-AndroidManifest
            COMMAND ${CMAKE_COMMAND} -E copy_directory ${CMAKE_SOURCE_DIR}/examples/${target_name}/resources ${project_directory}/assets/resources
        )
        add_custom_target(${target_name}_copy-SDL-java
            DEPENDS ${target_name}_copy-resources
            COMMAND ${CMAKE_COMMAND} -E copy_directory ${CMAKE_SOURCE_DIR}/SDL2/android-project/src/org ${project_directory}/src/org
        )
    else()
        add_custom_target(${target_name}_copy-SDL-java
            DEPENDS ${target_name}_copy-AndroidManifest
    ...
    add_custom_target(${target_name}_copy-java
        ...
        COMMAND ${CMAKE_COMMAND} -E copy_directory ${CMAKE_SOURCE_DIR}/examples/${target_name}/org ${project_directory}/src/org
    )
