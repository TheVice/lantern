...
if not exist %CURRENT_DIR%\build\%CMAKE_VER%\Android-%ANDROID_NATIVE_API_LEVEL%\%ANDROID_ABI%\RelWithDebInfo mkdir %CURRENT_DIR%\build\%CMAKE_VER%\Android-%ANDROID_NATIVE_API_LEVEL%\%ANDROID_ABI%\RelWithDebInfo
